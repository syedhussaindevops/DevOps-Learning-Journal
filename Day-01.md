...
- `ls` = List (It shows everything inside the current folder)
...
| `whoami` | Current user | Shows logged-in user |
| `date` | Current date/time | Displays system time |
| `clear` | Clear terminal | Clears the screen |
